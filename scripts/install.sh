...
log ""
log "=== Activation Tips ==="
log "  Slash commands available:"
log "    /task-planner          Plan a multi-step task (creates task_plan.md)"
log "    /task-drift-guard      Check if execution has drifted from plan"
log "    /todo                  Create persistent todo items with todo-skill"
log "  Or just say: "plan this" / "check drift" / "帮我规划一个多步骤任务""
