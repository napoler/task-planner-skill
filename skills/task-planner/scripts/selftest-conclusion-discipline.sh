...
#   CD-11 SKILL.md 含 "1-3[5-7]" 宽容锚且计数 ≥3（L9 全集/L278 References/L327 表三处；[2026-09-17 task-v079] 严格 '1-35'→宽容 1-3[5-7]，兼容 SKILL 1-35 现值与 P4 后 1-36）
...
#   CD-18 README.md 含 "Rules 1-3[5-7]" 宽容锚（S5 滞后的版本号修复在位，防回退 1-27；[2026-09-17 task-v079] 级联）
#   CD-19 batch-quality-gate.md 含 "隶属 Rules 1-3[5-7]" 宽容锚（S5 同批修复锚；[2026-09-17 task-v079] 级联）
...
# 2026-09-17 task-v079 S8a: CD-11/CD-18/CD-19 严格 '1-35' 锚改宽容 '1-3[5-7]'（SKILL 1-35→1-36 两阶段过渡自洽；CD-12 '1-34' 反回退锚保留）
...
n35=$(grep -cE '1-3[5-9]' "$SKILL" || true); n35=$((n35+0))
...
# CD-18 README 版本号修复锚
check "grep -qE 'Rules 1-3[5-9]' \"\$README_SKILL\"" "README.md 含 1-3[5-8] 宽容锚（task-v086 级联 1-38）（兼容 1-35/1-36 过渡）"
