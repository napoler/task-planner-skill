...
t "T2b SKILL.md 行数 ≤552（task-v076 扩充 545; [2026-09-17 task-v080] 调研路由增补 545→548; [2026-09-20 task-v085] 机制画像增量 548→549; [2026-09-20 task-v086] Rule 38 联动 549→551, 上限 549→552）" bash -c "[ \"\$(wc -l < '$SKILL')\" -le 552 ]"
