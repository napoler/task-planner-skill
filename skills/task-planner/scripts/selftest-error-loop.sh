...
#   EL-11 SKILL.md frontmatter/References 含 Rules 1-3[1-5]（宽容锚: P4 时为 1-32, P5 加 Rule 33/34 后改 1-34, S4 加 Rule 35 后改 1-35 仍命中）
...
# EL-11
if grep -qE 'Rules 1-3[1-5]' "$SKILLMD"; then ok 11 "SKILL.md Rules 1-3x 范围"; else bad 11 "SKILL.md 缺 Rules 1-3x"; fi
# EL-12
