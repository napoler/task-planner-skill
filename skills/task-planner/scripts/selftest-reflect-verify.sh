...
#   RV-10 SKILL.md 含 'Rules 1-3[56]' 宽容锚索引行（Rule 33/34/35/36 联动；[2026-09-17 task-v079] 严格 '1-35'→宽容 1-3[56]，兼容 1-35 现值与 P4 后 1-36）
...
# RV-10
if grep -qE 'Rules 1-3[56]' "$SKILL"; then ok 10 "SKILL.md 'Rules 1-3[56]' 宽容锚索引行（兼容 1-35/1-36 过渡）"; else bad 10 "SKILL.md 缺 'Rules 1-3[56]' 宽容锚"; fi
# RV-11
