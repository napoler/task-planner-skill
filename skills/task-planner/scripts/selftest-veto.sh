...
#   VT-10 SKILL.md 含 Rules 1-3[1-4]（宽容锚: P4 时为 1-32, P5 加 Rule 33/34 后改 1-34 仍命中）
...
# VT-10
if grep -qE 'Rules 1-3[1-4]' "$SKILLMD"; then ok 10 "SKILL.md Rules 1-3x 范围"; else bad 10 "SKILL.md 缺 Rules 1-3x"; fi
# VT-11
