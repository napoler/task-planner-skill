...
#   VT-10 SKILL.md 含 Rules 1-3[1-7]（宽容锚: [2026-09-17 task-v079] 扩至 1-36；[2026-09-20 task-v085] Rule 37 级联 1-3[1-7]）
...
# VT-10
if grep -qE 'Rules 1-3[1-9]' "$SKILLMD"; then ok 10 "SKILL.md Rules 1-3x 范围"; else bad 10 "SKILL.md 缺 Rules 1-3x"; fi
# VT-11
