...
# T10: SKILL.md 行数 ≤555（task-v073 Rule 32 摘要行+C20+否决登记指针 联动后 SKILL.md 529 行,上限同步 530→538; [2026-09-17 task-v079] Rule 36 联动净增 3 行,上限 538→548(B 类扩围 Decisions ⑧); [2026-09-20 task-v085] 机制画像增量 548→549; [2026-09-22 task-v087] Rule 8.1 D 类联动 551→555, 上限 552→555)
t "T10 SKILL.md 行数 ≤555" bash -c "[ \"\$(wc -l < '$SKILL')\" -le 555 ]"
