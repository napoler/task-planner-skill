# P1 selftest 基线（worktree@187194b, 2026-09-16T22:08:01Z）

**采集时间:** 2026-09-16T22:08:01Z
**脚本目录:** /mnt/data/dev/task-planner-skill-worktrees/task-v079-skill-modify-conservatism/skills/task-planner/scripts
**超时设置:** 120秒
...
CD-11 PASS SKILL.md '1-35' 计数 ≥3（当前=3）
...
CD-18 PASS README.md 含 'Rules 1-35'
CD-19 PASS batch-quality-gate.md 含 '隶属 Rules 1-35'
...
T11 PASS 11 (rc=0)
T12 PASS 12 (rc=0)
TS-01 PASS (rc=0, 锁写入=1789596494)
TS-02 PASS (rc=2, stderr 含 串行)
TS-03 PASS (rc=0, stderr 含 串行警告)
TS-04 PASS (rc=0, 锁刷新=1789596495)
...
RV-10 PASS SKILL.md 'Rules 1-35' 索引行
...
- **退出码:** 0
- **Total:** Total: 15 PASS=15 FAIL=0
- **PASS:** 15 | **FAIL:** 0

```
SM-01 PASS rc=3(期望3) PRECHECK_DIRTY=在
SM-02 PASS rc=0(期望0) MERGED=在
SM-03 PASS rc=0(期望0) ALREADY=在 master无新commit=是 无MERGE_HEAD残留(绝对路径 /tmp/tmp.pO9UAOCdP9/main/.git/MERGE_HEAD)=是
...
Deleted branch wt/task-test (was 39dfd70).
SM-10 PASS rc=6(期望6) 真实wt注入=是 REJECTED祖先=在 slot=/tmp/tmp.UfIj3kDvc2/ancestor(guard=/tmp/tmp.UfIj3kDvc2/ancestor/task-test) 零改动=是
